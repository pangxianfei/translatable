...
namespace Tmaic\Translatable\Tests;

use Tmaic\Translatable\Locales;
use Tmaic\Translatable\Tests\Eloquent\Country;
use Tmaic\Translatable\Tests\Eloquent\CountryStrict;
use Tmaic\Translatable\Tests\Eloquent\CountryTranslation;
use Tmaic\Translatable\Tests\Eloquent\Person;
use Tmaic\Translatable\Tests\Eloquent\Vegetable;
use Tmaic\Translatable\Tests\Eloquent\VegetableTranslation;
...
final class TranslatableTest extends TestCase
{
    ...
    public function it_finds_the_translation_class_with_suffix_set(): void
    {
        ...
        static::assertEquals(
            'Tmaic\Translatable\Tests\Eloquent\VegetableTrans',
